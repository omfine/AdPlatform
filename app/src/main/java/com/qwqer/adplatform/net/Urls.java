...
public interface Urls {
    ...
    //v2.0.3-用户|商户获取广告信息
    String advertInfo_user = "/express-inland-app/user/advertInfo/app/detail-customer";
    /**
...
//    String advertInfo_user_splash = "/express-inland-app/no-auth/advert/detail-customer";
    ...
    //v2.0.3-配送员获取广告信息
    String advertInfo_driver = "/express-inland-app/user/advertInfo/app/detail-worker";
    /**
     * v2.0.3-配送员获取开屏广告信息
     * 经邓优化，统一用上面的接口
     */
