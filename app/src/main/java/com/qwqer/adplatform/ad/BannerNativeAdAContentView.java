...
public class BannerNativeAdAContentView extends BaseView {
    ...
    public BannerNativeAdAContentView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public void setTTNativeAd(TTNativeAd ad , int imageCorner){
        ...
        if (null != list && !list.isEmpty()){
            ...
            GlideHelper.display(nativeImage , ttImage.getImageUrl() , imageCorner);
            //事件需要
...
//                    mBannerContainer.removeAllViews();
            ...
            dislikeView.setOnClickListener(new OnClickListener() {
                @Override
